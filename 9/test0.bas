c$=FN_add$("123", "325")
IF c$<>"448" THEN PRINT "bad"
c$=FN_add$("123", "32")
IF c$<>"155" THEN PRINT "bad"
c$=FN_add$("1545455727643343454", "8287258550227769974")
IF c$<>"9832714277871113428" THEN PRINT "bad"

PROC_test(5, "exinput.txt")
